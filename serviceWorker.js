var
 ...
 __ = {
  ...
  "https://core.parts/behaviors/copy-from-source.js": "return ''+_[υ.replace(''+destination,''+source)]",
  ...
  "https://core.parts/behaviors/resize/onpointerdown.js?archive": "https://core.parts/behaviors/resize/onpointerdown.a.js",
  ...
  "https://core.parts/bootstrap.js": "/*TODO: fix this */var\n ___ = {},\n onfetch = (_ = new Proxy({}, new Proxy($1, { get: (__, Υ) => eval(__[V = \"https://core.parts/proxy/alpha.js\"]) })))[\"https://core.parts/file.js\"],\n onmessage = _[\"https://core.parts/client-to-server.js\"]",
  "https://core.parts/client-to-server.js": "({ data, source }) => {\n const restart = () => source.postMessage({ restart: 1 })\n if (\"restart\" in data) registration.unregister().then(restart)\n else if (\"save\" in data) { Object.assign(__, data.save) }\n else throw new RangeError(`unhandled client to server command \"${JSON.stringify(data)}\"`)\n}",
  ...
  "https://core.parts/core-part/bootstrap.js": "" + (() => {
   ...
   globalThis.nodePool = {}
   const eventKireji = { onkeydown: 0, onkeyup: 0, onclick: 0, onwheel: 0, oncontextmenu: 0, onpointerdown: 0, onpointerup: 0, onpointermove: 0, ondblclick: 0, onfocus: 0, onblur: 0, layout: 1, manifest: 1, ondragstart: -1 };
   Object.defineProperties(HTMLElement.prototype, {
    ...
    url: {
     ...
     set(v) {
      ...
      nodePool[v].add(this)
      const proxy_keys = Object.keys(this.proxy), focus_events = ["onfocus", "onpointerdown", "onclick", "oncontextmenu", "onblur"];
       ...
       if (type === -1) {
        ...
        switch (type) {
         ...
         case 1:
          ...
          if (!(url in ___)) ___[url] = {}
          if (!(kireji in ___[url])) ___[url][kireji] = new Set()
          ___[url][kireji].add(this)
          break;
        }
       }
      }
  ...
  "https://core.parts/boot.html": "<!DOCTYPE html><meta name=robots content=noindex><body style=\"background:#222334;color:white;font:bold 11px/16px monospace;white-space:pre\" onload=\"var A,B=navigator.serviceWorker,C=x=>document.body.innerHTML+=x,D=()=>location.reload();B?B.controller?D():B.register('https:/'+`/${location.hostname}/boot.js`).then(E=>E.active?D():(E.waiting??E.installing).addEventListener('statechange',({target:t})=>{if(t.state==='activated')D()})):C(`error.<br>Your browser doesn't support ServiceWorker.<br>Please try a different browser.`)\">\n██╗  ██╗██╗██████╗ ██████╗     ██╗██╗\n██║ ██╔╝██║██╔══██╗██╔═══╝     ██║██║\n█████╔╝ ██║██████╔╝████╗       ██║██║\n██╔═██╗ ██║██╔══██╗██╔═╝  ██   ██║██║\n██║  ██╗██║██║  ██║██████╗╚█████╔╝██║\n╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═════╝ ╚════╝ ╚═╝\nInstalling...",
  "https://core.parts/oncontextmenu.js": "e => { e.preventDefault(); e.stopPropagation(); }",
  "https://core.parts/onpointermove.a.js": "return (\"\"+behavior) ? (\"\"+_[behavior]) : \"( ) => { }\"",
  ...
  "https://core.parts/onpointerup.a.js": "return `e => { ${(\"\"+grab) ? `_[\"${grab.headerOf().href}\"] = \"\"; ` : \"\"}${(\"\"+release) ? `_[\"${release}\"](e); _[\"${release.headerOf().href}\"] = \"\"; ` : \"\"}}`",
  "https://core.parts/onkeydown.js": "" + (e => {
   const shift_url = "https://core.parts/behaviors/shift.txt";
   if (e.key === "Shift" && ('' + _[shift_url]) === '0') _[shift_url] = '1'
  }),
  "https://core.parts/onkeyup.js": "" + (e => {
   const shift_url = "https://core.parts/behaviors/shift.txt";
   if (e.key === "Shift" && !e.shiftKey) _[shift_url] = '0'
  }),
  ...
  "https://core.parts/proxy/alpha.js": ("" + (() => ({
   get:
    (unused, υ) => {
     if (υ in runtime) return runtime[υ].β;
     const
     ...
     if (!Ψ) {
      throw new TypeError("AlphaError: bad request " + υ)
     }
     // console.log(υ)
     const
      extras = {
     ...
     α = new Proxy(Proxy, {
      get: (unused, π) => {
       ...
       const result = eval(`(${__[__[`${υ}?${π}`] ?? __[`${__[`${υ}?core`] ?? 'https://core.parts/core-part/'}?${π}`]] ?? __[`https://core.parts/proxy/beta/${π}.js`]})`)
       return result
      }
     })
     β = new Proxy(α, α)
     ...
     const
      ...
      onset = data => {
       for (const url in data)
        if (url in ___)
         Object.entries(___[url]).forEach(
          ([kireji, nodeset]) => {
  ...
  "https://core.parts/proxy/beta/apply.js": "" + ((unused1, unused2, A) => { return eval("" + α)(...A) }),
  "https://core.parts/proxy/beta/get.js": "" + ((unused, π) => {
   if (["toPrimitive", Symbol.toPrimitive, "toString", "valueOf", "headerOf", "rootsOf", "query", "getEmbedTag"].includes(π)) {
    return α[π]
   }
   let p, r = p = υ, result, exists, core_url = "https://core.parts/core-part/"
   do {
    exists = (result = __[url = `${r}?${π}`]) !== undefined
    if (exists)
     return _[result]

    if (r === core_url) break
    p = r
    r = __[`${r}?core`] ?? core_url
   } while (r !== p)
  }),
  ...
  "https://core.parts/proxy/beta/has.js": "" + ((unused, π) => {
  ...
  "https://core.parts/proxy/beta/toPrimitive.js": "" + ((hint, caller) => {
   const
    imagine = hint === "imagine",
    existing = __[υ]

   if (!imagine && existing !== undefined)
    return existing

   const
    archive_script = β.archive?.toPrimitive(),
    core_root = "https://core.parts/core-part/"

   if (!archive_script)
    return (β.core ?? _[core_root]).toPrimitive()
   ...
   for (const url in __) {
    ...
    do {
     ...
     if (r === base) {
      ...
      if (!properties.has(π) || properties.get(π)[0] > rank)
       properties.set(π, [rank, `"${__[url]}": ${π}`])
  ...
  "https://ejaugust.com/?core": "https://pilot.parts/",
  "https://kheb.online/favicon.ico?core": "https://core.parts/apple-touch-icon.png",
  "https://kheb.online/?core": "https://pilot.parts/",
  "https://stargate.design/?core": "https://pilot.parts/",
  "https://kireji.app/demo/hello.txt.a.js": "return `Welcome to my ${noun}, ${persons_name}! I've been ${verb_ending_in_ing} on it all ${time_interval}. I'm so ${mood} you ${past_phrasal_verb}.`",
  ...
  "https://kireji.app/?core": "https://pilot.parts/",
  ...
  "https://kireji.io/?core": "https://pilot.parts/",
  "https://orenjinari.com/favicon.ico?core": "https://core.parts/apple-touch-icon.png",
  "https://orenjinari.com/?core": "https://pilot.parts/",
  ...
  "https://pilot.parts/context-menu/onblur.js": "() => { _['https://pilot.parts/context-menu/open.txt'] = 0 }",
  "https://pilot.parts/context-menu/core-item/?layout": "https://pilot.parts/context-menu/core-item/layout.css",
  "https://pilot.parts/context-menu/core-item/layout.css.a.js": "return `:host { padding-left: 18px${υ.replace(\"layout.css\", \"\") === (\"\" + main) ? `; font-weight: 700` : ``} } :host(:hover) { background: rgb(0, 0, 163); color: white } :host::before { content: \"${_[υ.replace(\"layout.css\", \"label.txt\")]}\" }`",
  "https://pilot.parts/context-menu/core-item/layout.css?archive": "https://pilot.parts/context-menu/core-item/layout.css.a.js",
  ...
  "https://pilot.parts/context-menu/layout.css.a.js": "const { x, y } = JSON.parse(\"\" + position);\n return `\n :host {\n  display: flex;\n  flex-flow: column nowrap;\n  position: absolute;\n  left: ${x}px;\n  top: ${y}px;\n  user-select: none;\n  line-height: 18px;\n  text-align: left;\n  background: #c3c3c3;\n  box-sizing: border-box;\n  padding: 3px 3px 3px 3px;\n  text-align: left;\n  background: #c3c3c3;\n  min-width: 128px;\n  box-shadow:\n   inset -1px -1px black,\n   inset 1px 1px white,\n   inset -2px -2px #7a7a7a,\n   inset 2px 2px #dbdbdb;\n }`",
  ...
  "https://pilot.parts/desktop/layout.css.a.js": "return `\n  :host {\n   position: relative;\n   width: 100%;\n   box-sizing: border-box;\n   height: 100%;\n   margin: 0;\n   background: ${background};\n  }`",
  ...
  "https://pilot.parts/icons/application-json-icon/layout.css.a.js": "return layout([220, 220, 255], '\\u{1F4C4}', 'json', [1/7, 1/16, 1/8])",
  "https://pilot.parts/icons/application-json-icon/layout.css?archive": "https://pilot.parts/icons/application-json-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/application-wasm-icon/layout.css?archive": "https://pilot.parts/icons/application-wasm-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/image-png-icon/layout.css?archive": "https://pilot.parts/icons/image-png-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/image-vnd-microsoft-icon-icon/layout.css.a.js": "return layout([127, 127, 127, 0.25], '\\u{1F4C4}', 'ico', [0.1, 0.1, 0.1])",
  "https://pilot.parts/icons/image-vnd-microsoft-icon-icon/layout.css?archive": "https://pilot.parts/icons/image-vnd-microsoft-icon-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/physical-blemish-icon/layout.css.a.js": "return layout([255, 127, 127, 0.25], '🌋', undefined, [0.1, 0.1, 0.1])",
  "https://pilot.parts/icons/physical-blemish-icon/layout.css?archive": "https://pilot.parts/icons/physical-blemish-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/physical-car-part-icon/layout.css.a.js": "return layout([255, 127, 127, 0.25], '🚘', undefined, [0.1, 0.1, 0.1])",
  "https://pilot.parts/icons/physical-car-part-icon/layout.css?archive": "https://pilot.parts/icons/physical-car-part-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/physical-drink-stopper-icon/layout.css.a.js": "return layout([127, 127, 127, 0.25], '🍾', undefined, [0.1, 0.1, 0.1])",
  "https://pilot.parts/icons/physical-drink-stopper-icon/layout.css?archive": "https://pilot.parts/icons/physical-drink-stopper-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/physical-toy-icon/layout.css.a.js": "return layout([255, 127, 127, 0.25], '🎈', undefined, [0.1, 0.1, 0.1])",
  "https://pilot.parts/icons/physical-toy-icon/layout.css?archive": "https://pilot.parts/icons/physical-toy-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/text-css-icon/layout.css?archive": "https://pilot.parts/icons/text-css-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/text-html-icon/layout.css?archive": "https://pilot.parts/icons/text-html-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/text-javascript-icon/layout.css.a.js": "return layout([255, 127, 127, 0.7], '\\u{1F4C4}', 'js', [0.4])",
  "https://pilot.parts/icons/text-javascript-icon/layout.css?archive": "https://pilot.parts/icons/text-javascript-icon/layout.css.a.js",
  ...
  "https://pilot.parts/icons/text-uri-list-icon/layout.css.a.js": "return layout([0, 0, 0], \"\\u{1F4C4}\", \"uri\", [1, 1, 0.3])",
  "https://pilot.parts/icons/text-uri-list-icon/layout.css?archive": "https://pilot.parts/icons/text-uri-list-icon/layout.css.a.js",
  ...
  "https://pilot.parts/programs/answer/app-icon/layout.css?character": "https://pilot.parts/programs/answer/app-icon/character.txt",
  "https://pilot.parts/programs/answer/app-icon/layout.css?archive": "https://pilot.parts/programs/prototype/app-icon/layout.css.a.js",
  ...
  "https://pilot.parts/programs/answer/app-label/layout.css?archive": "https://pilot.parts/programs/prototype/app-label/layout.css.a.js",
  "https://pilot.parts/programs/answer/app-label/layout.css?label": "https://pilot.parts/programs/answer/app-label/label.txt",
  ...
  "https://pilot.parts/programs/answer/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/answer/task/layout.css?archive": "https://pilot.parts/programs/relate/task/layout.css.a.js",
  ...
  "https://pilot.parts/programs/answer/task/onpointerdown.js?archive": "https://pilot.parts/programs/relate/task/onpointerdown.a.js",
  ...
  "https://pilot.parts/programs/answer/window/active.txt?archive": "https://pilot.parts/programs/relate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/answer/window/controls/exit-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/answer/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/answer/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/answer/window/layout.css?archive": "https://pilot.parts/programs/welcome/window/layout.css.a.js",
  "https://pilot.parts/programs/answer/window/layout.css?position": "https://pilot.parts/programs/answer/window/position.json",
  "https://pilot.parts/programs/answer/window/manifest.uri.a.js": "const [title_url, panel_url, transform_url, position_url] = [title, panel, transform_path, position].map(x => x.headerOf().href)\nconst transform_urls = transform(transform_url, position_url, \"\", title_url);\nconst urlSet = [title_url, panel_url]\nif (transform_urls) urlSet.push(transform_urls)\nreturn urlSet.join(\" \")",
  "https://pilot.parts/programs/answer/window/manifest.uri?archive": "https://pilot.parts/programs/answer/window/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/answer/window/panel/manifest.uri": "https://pilot.parts/programs/answer/window/panel/heading/ https://pilot.parts/programs/answer/window/panel/menu/",
  ...
  "https://pilot.parts/programs/answer/window/panel/menu/manifest.uri?close_window": "https://pilot.parts/programs/answer/window/controls/exit-button/onclick.js",
  "https://pilot.parts/programs/answer/window/panel/menu/manifest.uri?archive": "https://pilot.parts/programs/answer/window/panel/menu/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/debate/connection/status.txt?archive": "https://pilot.parts/programs/debate/connection/status.txt.a.js",
  ...
  "https://pilot.parts/programs/debate/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/debate/task/layout.css?archive": "https://pilot.parts/programs/relate/task/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/task/onpointerdown.js?archive": "https://pilot.parts/programs/relate/task/onpointerdown.a.js",
  ...
  "https://pilot.parts/programs/debate/window/active.txt?archive": "https://pilot.parts/programs/relate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/exit-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/manifest.uri.a.js": "return `https://pilot.parts/programs/debate/window/controls/minimize-button/ https://pilot.parts/programs/debate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/ https://pilot.parts/programs/debate/window/controls/exit-button/`",
  "https://pilot.parts/programs/debate/window/controls/manifest.uri?archive": "https://pilot.parts/programs/debate/window/controls/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/maximize-button/layout.css.a.js": "return `:host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before {\n   --color: black;\n   display: block;\n   position: absolute;\n   content: \"\";\n   width: 9px;\n   height: 9px;\n   top: 2px;\n   left: 3px;\n   box-shadow: inset 0 2px var(--color), inset 0 0 0 1px var(--color) }\n  :host(:hover)::before {\n   --color: blue }`",
  "https://pilot.parts/programs/debate/window/controls/maximize-button/layout.css?archive": "https://pilot.parts/programs/debate/window/controls/maximize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/controls/restore-button/layout.css?archive": "https://pilot.parts/programs/locate/window/controls/restore-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/layout.css?archive": "https://pilot.parts/programs/debate/window/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/manifest.uri.a.js": "const  [title_url, panel_url, transform_url, position_url] = [title, panel, transform_path, position].map(x => x.headerOf().href), transform_urls = transform(transform_url, position_url, \"nesw\", title_url);\nreturn [title_url, panel_url, transform_urls].join(\" \")",
  "https://pilot.parts/programs/debate/window/manifest.uri?archive": "https://pilot.parts/programs/debate/window/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/debate/window/panel/status/layout.css?archive": "https://pilot.parts/programs/debate/window/panel/status/layout.css.a.js",
  ...
  "https://pilot.parts/programs/debate/window/panel/toolbar/manifest.uri?call_icon": "https://pilot.parts/programs/invite/app-icon/character.txt",
  "https://pilot.parts/programs/debate/window/panel/toolbar/manifest.uri?archive": "https://pilot.parts/programs/debate/window/panel/toolbar/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/debate/window/title-bar/ondblclick.a.js": "return `() => { _['https://pilot.parts/programs/debate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/onclick.js']() }`",
  "https://pilot.parts/programs/debate/window/title-bar/ondblclick.js?archive": "https://pilot.parts/programs/debate/window/title-bar/ondblclick.a.js",
  ...
  "https://pilot.parts/programs/invite/app-icon/layout.css?character": "https://pilot.parts/programs/invite/app-icon/character.txt",
  "https://pilot.parts/programs/invite/app-icon/layout.css?archive": "https://pilot.parts/programs/prototype/app-icon/layout.css.a.js",
  ...
  "https://pilot.parts/programs/invite/app-label/layout.css?archive": "https://pilot.parts/programs/prototype/app-label/layout.css.a.js",
  "https://pilot.parts/programs/invite/app-label/layout.css?label": "https://pilot.parts/programs/invite/app-label/label.txt",
  ...
  "https://pilot.parts/programs/invite/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/invite/task/layout.css?archive": "https://pilot.parts/programs/relate/task/layout.css.a.js",
  ...
  "https://pilot.parts/programs/invite/task/onpointerdown.js?archive": "https://pilot.parts/programs/relate/task/onpointerdown.a.js",
  ...
  "https://pilot.parts/programs/invite/window/active.txt?archive": "https://pilot.parts/programs/relate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/invite/window/controls/exit-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/invite/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/invite/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/invite/window/layout.css?archive": "https://pilot.parts/programs/welcome/window/layout.css.a.js",
  "https://pilot.parts/programs/invite/window/layout.css?position": "https://pilot.parts/programs/invite/window/position.json",
  "https://pilot.parts/programs/invite/window/manifest.uri.a.js": "const [title_url, panel_url, transform_url, position_url] = [title, panel, transform_path, position].map(x => x.headerOf().href)\nconst transform_urls = transform(transform_url, position_url, \"\", title_url);\nconst urlSet = [title_url, panel_url]\nif (transform_urls) urlSet.push(transform_urls)\nreturn urlSet.join(\" \")",
  "https://pilot.parts/programs/invite/window/manifest.uri?archive": "https://pilot.parts/programs/invite/window/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/invite/window/panel/menu/manifest.uri?close_window": "https://pilot.parts/programs/invite/window/controls/exit-button/onclick.js",
  "https://pilot.parts/programs/invite/window/panel/menu/manifest.uri?archive": "https://pilot.parts/programs/invite/window/panel/menu/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/app-label/layout.css.a.js": "return `\n  :host {\n   margin: 0;\n   height: 16px;\n   vertical-align: center;\n   text-overflow: ellipsis;\n   overflow: clip;\n  }\n  :host::after {\n   content: \"Locate - ${address}\";\n   white-space: nowrap;\n  }`",
  "https://pilot.parts/programs/locate/app-label/layout.css?address": "https://pilot.parts/programs/locate/window/address.uri",
  "https://pilot.parts/programs/locate/app-label/layout.css?archive": "https://pilot.parts/programs/locate/app-label/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/locate/window/active.txt.a.js": "return (\"\" + minimized) === \"1\" ? \"0\" : (\"\" + selected) === (\"\" + index) ? \"1\" : \"0\"",
  "https://pilot.parts/programs/locate/window/active.txt?archive": "https://pilot.parts/programs/locate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/locate/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/locate/window/controls/manifest.uri.a.js": "return `https://pilot.parts/programs/locate/window/controls/minimize-button/ https://pilot.parts/programs/locate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/ https://pilot.parts/programs/locate/window/controls/exit-button/`",
  "https://pilot.parts/programs/locate/window/controls/manifest.uri?archive": "https://pilot.parts/programs/locate/window/controls/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/window/controls/maximize-button/layout.css.a.js": "return `:host {\n    position: relative;\n    width: 16px;\n    height: 14px;\n    background: #c3c3c3;\n    box-shadow: ${(''+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n   }\n   :host::before {\n    --color: black;\n    display: block;\n    position: absolute;\n    content: '';\n    width: 9px;\n    height: 9px;\n    top: 2px;\n    left: 3px;\n    box-shadow: inset 0 2px var(--color), inset 0 0 0 1px var(--color)\n   }\n   :host(:hover)::before {\n    --color: blue }`",
  "https://pilot.parts/programs/locate/window/controls/maximize-button/layout.css?archive": "https://pilot.parts/programs/locate/window/controls/maximize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/controls/minimize-button/layout.css.a.js": "return `\n  :host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before {\n   --color: black;\n   display: block;\n   position: absolute;\n   content: \"\";\n   width: 6px;\n   height: 2px;\n   background: var(--color);\n   top: 9px;\n   left: 4px }\n  :host(:hover)::before {\n   --color: blue\n  }`",
  "https://pilot.parts/programs/locate/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/locate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/controls/restore-button/layout.css.a.js": "return `:host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before, :host::after {\n   --color: black;\n   display: block;\n   position: absolute;\n   content: \"\";\n   width: 6px;\n   height: 6px;\n   top: 5px;\n   left: 3px;\n   box-shadow: inset 0 2px var(--color), inset 0 0 0 1px var(--color);\n   background: #c3c3c3 }\n  :host::before {\n   top: 2px;\n   left: 5px }\n  :host(:hover)::before, :host(:hover)::after {\n   --color: blue }`",
  "https://pilot.parts/programs/locate/window/controls/restore-button/layout.css?archive": "https://pilot.parts/programs/locate/window/controls/restore-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/files/layout.css.a.js": "return `\n  :host {\n   position: relative;\n   display: grid;\n   grid-template-columns: ${JSON.parse(\"\"+name_width).w}px ${JSON.parse(\"\" + type_width).w}px ${JSON.parse(\"\" + size_width).w}px;\n   grid-auto-rows: 18px;\n   flex: 1 1;\n   overflow: auto;\n  }`",
  "https://pilot.parts/programs/locate/window/explorer-view/files/layout.css?archive": "https://pilot.parts/programs/locate/window/explorer-view/files/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/files/manifest.uri.a.js": ("" + (() => {
   const
    ...
    file_urls = Object.keys(__).filter(url => (url !== browse_url) && url.startsWith(browse_url)).map(x => x.replace(browse_url, "").includes("/") ? x.slice(0, browse_url.length + x.replace(browse_url, "").indexOf("/") + 1) : x);
   ...
   for (const [url, name, i] of filenames) {
    ...
    _["https://pilot.parts/programs/relate/window/selection.uri"] = "${url + (row_data.type === "protocol" ? "/" : "")}";
   ...
   `} }`
    for (const key in header) {
     ...
     if (key === "name") {
      ...
      _[keyurl + "oncontextmenu.js"] = `({ clientX: x, clientY: y }) =>{ _["https://pilot.parts/context-menu/position.json"] = JSON.stringify({ x, y }); _["https://pilot.parts/context-menu/open.txt"] = "1"; [...nodePool["https://pilot.parts/context-menu/"]].find(x => x.isConnected).focus() }`
     } else {
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/files/manifest.uri?archive": "https://pilot.parts/programs/locate/window/explorer-view/files/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/header/layout.css.a.js": "return `:host {\n   display: grid;\n   width: 100%;\n   grid-template-columns: ${JSON.parse(\"\"+name_width).w}px ${JSON.parse(\"\" + type_width).w}px ${JSON.parse(\"\" + size_width).w}px 1fr;\n  }`",
  "https://pilot.parts/programs/locate/window/explorer-view/header/layout.css?archive": "https://pilot.parts/programs/locate/window/explorer-view/header/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/header/manifest-fx.uri.a.js": "return Object.keys(JSON.parse(\"\"+sort_order)).map(key => `https://pilot.parts/programs/locate/window/explorer-view/header/${key}-button/layout.css`).join(\" \")",
  "https://pilot.parts/programs/locate/window/explorer-view/header/manifest-fx.uri?archive": "https://pilot.parts/programs/locate/window/explorer-view/header/manifest-fx.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/window/explorer-view/header/manifest.uri?archive": "https://pilot.parts/programs/locate/window/explorer-view/header/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/window/layout.css?archive": "https://pilot.parts/programs/locate/window/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/manifest.uri.a.js": "const [title_url, tools_url, explorer_url, status_url, transform_url, position_url] = [title, tools, explorer, status, transform_path, position].map(x => x.headerOf().href)\nconst transform_urls = transform(transform_url, position_url, \"nesw\", title_url);\nreturn [title_url, tools_url, explorer_url, status_url, transform_urls].join(\" \")",
  "https://pilot.parts/programs/locate/window/manifest.uri?archive": "https://pilot.parts/programs/locate/window/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/locate/window/status/layout.css?archive": "https://pilot.parts/programs/locate/window/status/layout.css.a.js",
  ...
  "https://pilot.parts/programs/locate/window/title-bar/ondblclick.a.js": "return `() => { _['https://pilot.parts/programs/locate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/onclick.js']() }`",
  "https://pilot.parts/programs/locate/window/title-bar/ondblclick.js?archive": "https://pilot.parts/programs/locate/window/title-bar/ondblclick.a.js",
  ...
  "https://pilot.parts/programs/locate/window/tool-bar/manifest.uri?archive": "https://pilot.parts/programs/locate/window/tool-bar/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/relate/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/relate/task/layout.css?archive": "https://pilot.parts/programs/relate/task/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/task/onpointerdown.js?archive": "https://pilot.parts/programs/relate/task/onpointerdown.a.js",
  ...
  "https://pilot.parts/programs/relate/window/active.txt.a.js": "const active = (\"\" + minimized) === '1' ? '0' : (\"\" + selected) === (\"\" + index) ? '1' : '0'; return active;",
  "https://pilot.parts/programs/relate/window/active.txt?archive": "https://pilot.parts/programs/relate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js": "return `\n  :host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   margin-left: 2px;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before, :host::after {\n   --color: black;\n   content: \"\";\n   display: block;\n   position: absolute;\n   width: 8px;\n   height: 7px;\n   left: 4px;\n   top: 3px;\n   background: linear-gradient(to top left, transparent 0%, transparent calc(50% - 1px), var(--color) calc(50% - 1px), var(--color) calc(50% + 1px),  transparent calc(50% + 1px),  transparent 100%), linear-gradient(to top right,  transparent 0%,  transparent calc(50% - 1px), var(--color) calc(50% - 1px), var(--color) calc(50% + 1px),  transparent calc(50% + 1px),  transparent 100%);\n  }\n  :host(:hover)::before {\n   --color: blue\n  }`",
  "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/manifest.uri.a.js": "return `https://pilot.parts/programs/relate/window/controls/minimize-button/ https://pilot.parts/programs/relate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/ https://pilot.parts/programs/relate/window/controls/exit-button/`",
  "https://pilot.parts/programs/relate/window/controls/manifest.uri?archive": "https://pilot.parts/programs/relate/window/controls/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/maximize-button/layout.css.a.js": "return `:host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before {\n   --color: black;\n   display: block;\n   position: absolute;\n   content: \"\";\n   width: 9px;\n   height: 9px;\n   top: 2px;\n   left: 3px;\n   box-shadow: inset 0 2px var(--color), inset 0 0 0 1px var(--color) }\n  :host(:hover)::before {\n   --color: blue }`",
  "https://pilot.parts/programs/relate/window/controls/maximize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/maximize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js": "return `:host {\n   position: relative;\n   width: 16px;\n   height: 14px;\n   background: #c3c3c3;\n   box-shadow: ${(\"\"+down) === '1' ? 'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a' : 'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb'}\n  }\n  :host::before {\n   --color: black;\n   display: block;\n   position: absolute;\n   content: \"\";\n   width: 6px;\n   height: 2px;\n   background: var(--color);\n   top: 9px;\n   left: 4px }\n  :host(:hover)::before {\n   --color: blue }`",
  "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/controls/restore-button/layout.css?archive": "https://pilot.parts/programs/locate/window/controls/restore-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/core-node/layout.css.a.js": ("" + (() => {
   const { x = 0, y = 0, w = 0 } = JSON.parse("" + position), selected_bool = '' + selected === '1'
   return `
    :host {
     position: absolute;
   ...
   `})).slice(7, -1),
  "https://pilot.parts/programs/relate/window/core-node/layout.css?archive": "https://pilot.parts/programs/relate/window/core-node/layout.css.a.js",
  "https://pilot.parts/programs/relate/window/core-node/manifest.uri?cell": "https://core.parts/components/cell/construct.js",
  "https://pilot.parts/programs/relate/window/core-node/manifest.uri?click": "https://core.parts/components/click/construct.js",
  "https://pilot.parts/programs/relate/window/core-node/manifest.uri?archive": "https://pilot.parts/programs/relate/window/core-node/manifest.a.js",
  ...
  "https://pilot.parts/programs/relate/window/core-node/position.json.a.js": "return JSON.stringify({ w: 9 * 18, range: { w: [5 * 18] }, snap: { x: 9, y: 9 } })",
  "https://pilot.parts/programs/relate/window/core-node/position.json?archive": "https://pilot.parts/programs/relate/window/core-node/position.json.a.js",
  ...
  "https://pilot.parts/programs/relate/window/graph/?onwheel": "https://pilot.parts/programs/relate/window/graph/onwheel.js",
  ...
  "https://pilot.parts/programs/relate/window/graph/layout.css?archive": "https://pilot.parts/programs/relate/window/graph/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/graph/layout.css?zoom": "https://pilot.parts/programs/relate/window/graph/zoom.txt",
  "https://pilot.parts/programs/relate/window/graph/layout.css?white_grid": "https://core.parts/img/white-grid.png",

  "https://pilot.parts/programs/relate/window/graph/manifest.uri?source": "https://pilot.parts/programs/relate/graphs/source.uri",
  "https://pilot.parts/programs/relate/window/graph/manifest.uri?node_list": "https://pilot.parts/programs/relate/window/graph/nodes.uri",
  "https://pilot.parts/programs/relate/window/graph/manifest.uri?archive": "https://pilot.parts/programs/relate/window/graph/manifest.uri.a.js",
  "https://pilot.parts/programs/relate/window/graph/manifest.uri?transform": "https://core.parts/components/transform/construct.js",

  "https://pilot.parts/programs/relate/window/graph/onwheel.js": "" + (e => {
   if (e.ctrlKey) return;
   ...
   _["https://pilot.parts/programs/relate/window/graph/zoom.txt"] = Math.min(Math.max(parseFloat("" + _["https://pilot.parts/programs/relate/window/graph/zoom.txt"]) * (1 + e.deltaY * speed_factor), 0.01), 100)
   console.log('wheeling', e.deltaY, "" + _["https://pilot.parts/programs/relate/window/graph/zoom.txt"])
   globalThis.dampen_wheel = false
  }),
  "https://pilot.parts/programs/relate/window/graph/onpointerdown.js?archive": "https://pilot.parts/programs/relate/window/graph/move_graph.js",
  "https://pilot.parts/programs/relate/window/graph/onpointerdown.js?source": "https://pilot.parts/programs/relate/graphs/source.uri",
  ...
  "https://pilot.parts/programs/relate/window/graph/onpointerdown.js?stop_propagation": "https://core.parts/const/zero.txt",
  ...
  "https://pilot.parts/programs/relate/window/graph/move_graph.js": ("" + (() => {
   ...
   const hash = _["https://core.parts/core-part/hash.js"];
   const selection_url = "https://pilot.parts/programs/relate/window/graph/selection.uri", selection_string = '' + _[selection_url], selection_list = selection_string ? selection_string.split(' ') : []
   _[selection_url] = ''
   ...
   _["${transformer_url}"] = \`({ clientX: x, clientY: y }) => {
    ...
    if (!object.range.h.length) delete object.range.h
    if (!Object.keys(object.range).length) delete object.range
    _["${input_url}"] = _["${source_url}"] = JSON.stringify(object)
   }\`
   _["https://core.parts/behaviors/grab/src.uri"] = "${transformer_url}";
  }`})).slice(7, -1),
  "https://pilot.parts/programs/relate/graphs/?archive": "https://core.parts/behaviors/copy-from-source.js",
  "https://pilot.parts/programs/relate/graphs/?destination": "https://pilot.parts/programs/relate/graphs/destination.uri",
  ...
  "https://pilot.parts/programs/relate/graphs/source.uri?fx": "https://pilot.parts/programs/relate/window/graph/regraph.uri",
  "https://pilot.parts/programs/relate/window/graph/regraph.uri": "https://pilot.parts/programs/relate/window/graph/nodes.uri https://pilot.parts/programs/relate/window/graph/position.json https://pilot.parts/programs/relate/window/graph/manifest.uri https://pilot.parts/programs/relate/window/graph/onpointerdown.js",
  ...
  "https://pilot.parts/programs/relate/window/graph/manifest.uri.a.js": ("" + (() => {
   const
    ...
    result_urls = [...kireji_urls].map(address => {
     const
      node_url = `${graph_url}${hash(source + " " + address + " node")}/node/`,
     ...
     if ('' + _[`${node_url}?core`] === node_core_url) return node_url
     _[`${node_url}?core`] = node_core_url
     _[`${node_url}?layout`] = layout_url
     ...
     _[`${node_url}layout.css?selected`] = selected_url
     _[selected_url] = '0'
     _[reposition_url] = layout_url
     ...
     _[`${node_url}manifest.uri?expand`] = `${node_url}expand.txt`
     _[`${node_url}expand.txt`] = "0"
     _[`${node_url}expand.txt?fx`] = `${node_url}onexpand.uri`
     _[`${node_url}onexpand.uri`] = `${node_url}manifest.uri`
     ...
     _[reposition_url] = `${node_url}layout.css`
     _[`${node_url}position.json?fx`] = _[`${selected_url}?fx`] = reposition_url
  ...
  "https://pilot.parts/programs/relate/window/core-node/manifest.a.js": ("" + (() => {
   ...
   _[toggle_open_url] = `()=>{
    _["${expand.headerOf().href}"] = "${"" + expand === "1" ? 0 : 1}"
   }`
  ...
  "https://pilot.parts/programs/relate/window/core-node/onpointerdown.js": ("" + (event => {
   ...
   const
    ...
    source_url = '' + _["https://pilot.parts/programs/relate/graphs/source.uri"],
    { clientX: x, clientY: y } = event,
    shift_url = "https://core.parts/behaviors/shift.txt",
    selection_string = '' + _[selection_url],
    actual_node_url = υ.slice(0, -16),
    hash = _["https://core.parts/core-part/hash.js"],
    target_node_url = _[actual_node_url + 'manifest.uri'].word.headerOf().href;
   ...
   if ('' + _[shift_url] === '1') {
    if (target_index === -1) {
     ...
     _[actual_node_url + 'selected.txt'] = '1'
     console.log('add target')
    }
    else {
     selection_list.splice(target_index, 1)
     _[actual_node_url + 'selected.txt'] = '0'
     console.log('remove target')
    }
    _[selection_url] = _[source_url + 'selection.uri'] = selection_list.join(' ')
   }
   else if (target_index === -1 && selection_string !== target_node_url) {
    _[selection_url] = _[source_url + 'selection.uri'] = target_node_url
    for (const selection_url of selection_list) {
     const node_url = `https://pilot.parts/programs/relate/window/graph/${hash(source_url + " " + selection_url + " node")}/node/`
     _[node_url + 'selected.txt'] = '0'
    }
   ...
   for (const selection_url of selection_list) {
    ...
    const
     { x: X = 0, y: Y = 0, w: W = 0, h: H = 0, range = {}, snap = {} } = JSON.parse(_[position_url].toPrimitive()),
     { x: rx = [], y: ry = [], w: rw = [], h: rh = [] } = range,
     { x: sx = 1, y: sy = 1 } = snap,
     [min_x = -Infinity, max_x = Infinity] = rx,
     [min_y = -Infinity, max_y = Infinity] = ry,
   ...
   _[transformer_url] = `({ clientX: x, clientY: y }) => {
    const object_list = {
     ${Object.entries(properties).map(([key, json]) => `"${key}":${json}`).join(',')}
    }
    for (const url in object_list) {
     ...
     if (!object.range.h.length) delete object.range.h
     if (!Object.keys(object.range).length) delete object.range
     _[url] = JSON.stringify(object)
    }
   }`
   _["https://core.parts/behaviors/grab/src.uri"] = transformer_url;
  })),
  "https://pilot.parts/programs/relate/window/graph/selection.uri?core": "https://pilot.parts/programs/relate/graphs/",

  "https://pilot.parts/programs/relate/window/graph/nodes.uri?core": "https://pilot.parts/programs/relate/graphs/",
  "https://pilot.parts/programs/relate/window/graph/nodes.uri?fx": "https://pilot.parts/programs/relate/window/graph/renode.uri",
  "https://pilot.parts/programs/relate/window/graph/renode.uri": "https://pilot.parts/programs/relate/window/graph/manifest.uri",

  "https://pilot.parts/programs/relate/window/graph/position.json?core": "https://pilot.parts/programs/relate/graphs/",
  ...
  "https://pilot.parts/programs/relate/window/graph/zoom.txt?core": "https://pilot.parts/programs/relate/graphs/",
  "https://pilot.parts/programs/relate/window/graph/zoom.txt?fx": "https://pilot.parts/programs/relate/window/graph/rezoom.uri",
  "https://pilot.parts/programs/relate/window/graph/rezoom.uri": "https://pilot.parts/programs/relate/window/graph/layout.css",
  ...
  "https://pilot.parts/programs/relate/graphs/default/nodes.uri": "https://kireji.app/demo/hello.txt https://pilot.parts/programs/relate/window/layout.css",
  ...
  "https://pilot.parts/programs/relate/graphs/graph-1/nodes.uri": "https://pilot.parts/programs/relate/window/manifest.uri https://pilot.parts/",
  ...
  "https://pilot.parts/programs/relate/window/layout.css?archive": "https://pilot.parts/programs/relate/window/layout.css.a.js",
  ...
  "https://pilot.parts/programs/relate/window/manifest.uri.a.js": "const [title_url, graph_url, tools_url, transform_url, position_url] = [title, graph, tools, transform_path, position].map(x => x.headerOf().href)\nconst transform_urls = transform(transform_url, position_url, \"nesw\", title_url);\nreturn [title_url, tools_url, graph_url, transform_urls].join(\" \")",
  "https://pilot.parts/programs/relate/window/manifest.uri?archive": "https://pilot.parts/programs/relate/window/manifest.uri.a.js",
  "https://pilot.parts/programs/relate/window/manifest.uri?graph": "https://pilot.parts/programs/relate/window/graph/",
  "https://pilot.parts/programs/relate/window/manifest.uri?tools": "https://pilot.parts/programs/relate/window/tool-bar/",
  ...
  "https://pilot.parts/programs/relate/window/title-bar/ondblclick.a.js": "return `() => { _['https://pilot.parts/programs/relate/window/controls/${(\"\"+maximized) === '1' ? 'restore' : 'maximize'}-button/onclick.js']() }`",
  "https://pilot.parts/programs/relate/window/title-bar/ondblclick.js?archive": "https://pilot.parts/programs/relate/window/title-bar/ondblclick.a.js",
  "https://pilot.parts/programs/relate/window/title-bar/ondblclick.js?maximized": "https://pilot.parts/programs/relate/window/maximized.txt", "https://pilot.parts/programs/locate/window/tool-bar/?layout": "https://pilot.parts/programs/locate/window/tool-bar/layout.css",
  "https://pilot.parts/programs/relate/window/tool-bar/?layout": "https://pilot.parts/programs/relate/window/tool-bar/layout.css",
  "https://pilot.parts/programs/relate/window/tool-bar/?manifest": "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri",
  "https://pilot.parts/programs/relate/window/tool-bar/layout.css": "\n  :host {\n   height: 18px;\n   display: flex;\n   flex-flow: row nowrap;\n   gap: 4px;\n   align-items: center;\n   padding: 2px;\n  }\n  :host > * {\n   box-shadow:\n  }",
  "https://pilot.parts/programs/relate/window/graph/layout.js": "" + (node_position_urls => {
   const
    node_positions = {},
    gravity = -0.1,
    energy = 5,
   ...
   for (let i = 0; i <= last_i; i++) {
    const
     node_position_url = node_position_urls[i],
     node_position = JSON.parse('' + _[node_position_url]),
    ...
    if (i) for (const previous_node_position_url in node_positions) {
     const
      previous_node_position = node_positions[previous_node_position_url],
  ...
  for (const url in node_positions) {
   ...
   _[url] = JSON.stringify(node_positions[url])
  }
  /*
  ...
  */
  ...
  "https://pilot.parts/programs/relate/window/onplay.uri": "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri https://pilot.parts/programs/relate/window/tool-bar/arrange-graph/layout.css",
  ...
  "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri.a.js": ("" + (() => {
   ...
   return [[
    ...
    "" + (() => {
     ...
     const
      node_path = "https://pilot.parts/programs/relate/window/graph/",
      layout = _[`${node_path}layout.js`],
      manifest_proxy = _[`${node_path}manifest.uri`],
      loop = () => {
    ...
    "",
    "" + (() => {
     const source_uri = '' + _["https://pilot.parts/programs/relate/graphs/source.uri"];
     _["https://pilot.parts/programs/relate/window/graph/selection.uri"] = _[source_uri + 'selection.uri'] = ""
     _["https://pilot.parts/programs/relate/window/graph/nodes.uri"] = _[source_uri + 'nodes.uri'] = ""
    ...
    "" + (() => {
     const
      node_path = "https://pilot.parts/programs/relate/window/graph/",
      selection_string = '' + _[`${node_path}selection.uri`],
      selection_list = selection_string ? selection_string.split(' ') : [],
      source_uri = '' + _["https://pilot.parts/programs/relate/graphs/source.uri"],
      node_list_uri = `${node_path}nodes.uri`,
      node_list_string = '' + _[node_list_uri],
      //layout = _[`${node_path}layout.js`],
      node_list = node_list_string ? node_list_string.split(' ') : [],
      node_set = new Set(node_list),
      new_node_list = [];
     for (const selection_url of selection_list) _[selection_url].query(l => l.root === selection_url ? l.href : undefined).forEach(v => {
      if (node_set.has(v)) return;
      node_set.add(v)
      new_node_list.push(v)
     })
     _[node_list_uri] = _[source_uri + 'nodes.uri'] = [...node_set].join(' ')
    ...
    "" + (() => {
     const
      src_url = "https://pilot.parts/programs/relate/graphs/source.uri",
      old_graph = '' + _[src_url],
      url_a = "https://pilot.parts/programs/relate/graphs/graph-1/",
      url_b = "https://pilot.parts/programs/relate/graphs/default/";
     _[src_url] = old_graph === url_a ? url_b : url_a
    }),
   ]].map($ => { button(...$); return $[0] }).join(" ")
  })).slice(7, -1),
  "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri?button": "https://core.parts/components/button/construct.js",
  "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri?archive": "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri.a.js",
  "https://pilot.parts/programs/relate/window/tool-bar/manifest.uri?show_kireji": "https://pilot.parts/programs/relate/window/explorer-view/show_kireji.txt",
  ...
  "https://pilot.parts/programs/welcome/task/index.txt?archive": "https://pilot.parts/programs/locate/task/index.txt.a.js",
  ...
  "https://pilot.parts/programs/welcome/task/layout.css?archive": "https://pilot.parts/programs/relate/task/layout.css.a.js",
  ...
  "https://pilot.parts/programs/welcome/task/onpointerdown.js?archive": "https://pilot.parts/programs/relate/task/onpointerdown.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/active.txt?archive": "https://pilot.parts/programs/relate/window/active.txt.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/controls/exit-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/exit-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/controls/exit-button/onclick.js?archive": "https://core.parts/behaviors/window-close.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/controls/minimize-button/layout.css?archive": "https://pilot.parts/programs/relate/window/controls/minimize-button/layout.css.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/layout.css?archive": "https://pilot.parts/programs/welcome/window/layout.css.a.js",
  "https://pilot.parts/programs/welcome/window/layout.css?position": "https://pilot.parts/programs/welcome/window/position.json",
  "https://pilot.parts/programs/welcome/window/manifest.uri.a.js": "const [title_url, panel_url, transform_url, position_url] = [title, panel, transform_path, position].map(x => x.headerOf().href)\nconst transform_urls = transform(transform_url, position_url, \"\", title_url);\nconst urlSet = [title_url, panel_url]\nif (transform_urls) urlSet.push(transform_urls)\nreturn urlSet.join(\" \")",
  "https://pilot.parts/programs/welcome/window/manifest.uri?archive": "https://pilot.parts/programs/welcome/window/manifest.uri.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/panel/tip/layout.css?archive": "https://pilot.parts/programs/welcome/window/panel/tip/layout.css.a.js",
  ...
  "https://pilot.parts/programs/welcome/window/panel/tip/tip-19.txt": "🔗 Kireji are used to link files to 'archive' and 'runtime' constructors.",
  ...
  "https://pilot.parts/programs/welcome/window/panel/tip/tip-21.txt": "A 'archive' is a file used to generate another file.",
  ...
  "https://pilot.parts/taskbar/manifest.uri.a.js": ("" + (() => {
   return `https://pilot.parts/taskbar/start-button/ ${"" + running_apps ? running_apps + " " : ""}https://core.parts/flex-spacer/ https://pilot.parts/taskbar/tray/`
  })).slice(7, -1),
  ...
  "https://pilot.parts/taskbar/start-button/icon/layout.css.a.js": "return `:host {\n   position: relative;\n   box-sizing: border-box;\n   height: 100%;\n   margin: 0;\n   background: url(data:image/png;base64,${icon});\n   background-size: 16px;\n   width: 16px;\n   height: 16px }`",
  "https://pilot.parts/taskbar/start-button/icon/layout.css?archive": "https://pilot.parts/taskbar/start-button/icon/layout.css.a.js",
  ...
  "https://pilot.parts/taskbar/start-button/layout.css?archive": "https://pilot.parts/taskbar/start-button/layout.css.a.js",
  ...
  "https://pilot.parts/taskbar/start-button/onpointerdown.js?archive": "https://pilot.parts/taskbar/start-button/onpointerdown.a.js",
  ...
  "https://pilot.parts/taskbar/start-menu/save-computer-as/onclick.js": "\n   () => {\n    _[\"https://pilot.parts/start-menu/open.txt\"] = \"0\"\n    delete __[\"https://pilot.parts/taskbar/tray/clock/date.txt\"]\n    delete __[\"https://pilot.parts/taskbar/tray/clock/layout.css\"]\n    const\n     a = document.createElement(\"a\"),\n     json = JSON.stringify(Object.keys(__).sort().reduce((temp_obj, key) => { temp_obj[key] = __[key]; return temp_obj }, {})).replace(/\",\"/g,\"\\\",\\n  \\\"\").replace(/^{/s, \"{\\n  \").replace(/}$/s, \"\\n}\"),\n     js = __[\"https://core.parts/bootstrap.js\"].replace(\"$1\", json),\n     ourl = URL.createObjectURL(new Blob([js], { type: \"text/javascript\" }));\n     a.href = ourl\n     a.download = \"boot.js\"\n     document.body.appendChild(a)\n    a.click();\n     a.remove()\n     URL.revokeObjectURL(ourl);\n   }",
  ...
  "https://pilot.parts/taskbar/tray/clock/date.txt.a.js": "return new Date().toLocaleString(\"en-US\", { hour: \"numeric\", minute: \"numeric\", hourCycle: \"h12\" })",
 ...
 }, ___ = {}, _ = new Proxy({}, new Proxy(__, { get: (unused, Υ) => eval(__[V = "https://core.parts/proxy/alpha.js"]) }));

var
 onfetch = _['https://core.parts/file.js'],
 onmessage = _['https://core.parts/client-to-server.js'];
