return scroller.wrap(
 ...
 "<footer>" + (
  ...
  "</section>" +
  `<a ${_.pointAttr()} class=external  title="Visit Site Repo" id=k-logo href="https://github.com/kireji-app/demo#readme"><pre>${welcomeMessage.replace("k =", "<span id=k>k</span> =")}</pre></a>` +
  "<section id=social>" + (
