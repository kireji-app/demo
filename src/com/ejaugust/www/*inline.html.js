return ejaugust[".."].scroller.wrap(
 "<header>" + (
  `<a id=notebook-title title="⌂ Home" href=https://www.ejaugust.com/ onclick=_?.go(this,event)>` + (
   `<h1>` + (
 ...
 "<footer>" + (
  "<section id=quick-links>" + (
   "<a id=footer-home href=https://www.ejaugust.com/ onclick=_?.go(this,event)><span class=unicode-icon>⌂</span> Home</a>" +
   '<a href=https://www.ejaugust.com/#top onclick=_?.go(this,event)><span class=unicode-icon>↑</span> Back to Top</a>'
  ) +
  "</section>" +
