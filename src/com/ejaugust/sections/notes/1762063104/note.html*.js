...
<p>However, because this notebook is embedded into a larger app ecosystem, the URL in your addressbar is a little more complicated than this simple hash. Check out <a href=https://ejaugust.com/notes/1762063947 onpointerdown=self._?.point(event,this)>this note</a> to see the state of the ecosystem as a whole.</p>`