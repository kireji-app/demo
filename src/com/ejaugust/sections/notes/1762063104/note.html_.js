...
<p>However, because this notebook is embedded into a larger app ecosystem, the URL in your addressbar is a little more complicated than this simple hash. Check out <a ${_.pointAttr()} href=${notes[1762063947].canonicalURL}>this note</a> to see the state of the ecosystem as a whole.</p>`