if (hydrated) {
 ...
 for (const alreadyOpenView of document.querySelectorAll(`part-outliner details[open]>summary`)) {
...
<line x1="0" y1="-0.41" x2="0" y2="0.41" stroke-width="0.2" stroke-linecap="round" />`
 ...
 for (const partToOpen of partsToOpen) {
  const closedView = document.querySelector(`part-outliner details>summary[data-index="${allParts.indexOf(partToOpen)}"]`)
