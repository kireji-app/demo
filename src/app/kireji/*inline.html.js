...
return (
 ...
 // `<h2 id=editor-header>${svg("M 0.5 0 A 0.5 0.5 0 1 1 0 -0.5 M 0 -0.2 L 0.3 -0.45 L 0 -0.7")}<span>Property Viewer</span></h2>` +
 // ${svg("", "M -0.3 0 L 0.3 0.5 M 0.3 -0.5 L -0.3 0")}${svg("", "M 0.3 0 L -0.3 0.5 M -0.3 -0.5 L 0.3 0")}
 `<h2 id=editor-header>${svg("self._?.app.kireji.outliner.width.toggle(event)", "M 0 0.5 L 0 0.5 M 0 0 L 0 0 M 0 -0.5 L 0 -0.5")} Property Viewer</h2>` +
 outliner["inline.html"] +
 "<part-editor>" + editor["inline.html"] + "</part-editor>" +
