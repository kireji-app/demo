declare class PartAddressBar extends UserModule {
 ...
 /** The route object that was created from `location.href` when the address bar module was first installed. */
...
/** A window module representing the browser address bar that provides `pathname <=> route ID` mapping to all environments. */
