...
function boot() {
 const 𝕐 = {
   // ===================================================================================
   "https://orenjinari.com/core.uri": "https://core.parts",
   "https://orenjinari.com/enter.js": `this.stylesheet = this.controller.stylesheet
this.stylesheet.replaceSync(\`
:host {
 background: silver;
}\`)`,
   // ===================================================================================
   "https://core.parts/version.txt": "0.87.7",
   "https://core.parts/verbose.txt": "",
...
if (index < 0n || index >= this.size) throw new RangeError(\`index \${index} out of range (size \${this.size}): \${this.origin}\`)
this.index = index
}`,
   "https://core.parts/leave.js": `this.index = 0n`,
   "https://core.parts/notify.js": `this.controller?.notify(this.origin)`,
   // ===================================================================================
...
this.parts = parts.reduceRight((parts, part, i) => {
 ...
 if (!(part instanceof T\`https://core.parts\`)) throw new TypeError(\`unexpected \${typeof part} encountered as factor of composite \${this.origin}\`)
...
this.parts = parts.map((part, i) => {
 if (typeof part === "string") part = part.startsWith("https://") ? new (T([part]))() : new (T([\`https://\${part}.\${this.origin.slice(8)}\`]))()
 if (!(part instanceof T\`https://core.parts\`)) throw new TypeError(\`unexpected \${typeof e} encountered at part = \${i} of decision \${this.origin}\`)
...
this.option = this.options[this.parts[0].origin]
...
super.notify(from)`,
   // =======================
   "https://boot.core.parts/core.uri": "https://decision.core.parts",
   "https://boot.core.parts/constructor.js": `super(["empty", "server", "client"])`,
   "https://boot.core.parts/enter.js": `await super.enter()
await this.populate(this.options[\`https://\${E}.boot.core.parts\`].offset)
this.controller?.notify(this.origin)`,

   "https://server.boot.core.parts/enter.js": `const cache = {},
...
<head>
 ...
 <title>Loading ...</title>
  ...
  globalThis.onmessage = e => [onactivate, () => registration.unregister().then(() => e.source.postMessage({ code: 0 }))][e.data.code]()`,
   ...
   "https://client.boot.core.parts/core.uri": "https://decision.core.parts",
   "https://client.boot.core.parts/constructor.js": `super(["https://empty.core.parts", "https://menu.core.parts"])`,
...
const loop = now => {
 ...
 if (this.index !== this.documentIndex) this.populate(this.documentIndex).then(() => this.controller?.notify(this.origin))
...
/*
 setTimeout(() => {
  ...
  const order = ["core.parts", "fallback.cloud", "kireji.io", "glowstick.click", "ejaugust.com", "orenjinari.com"],
  next = order[(order.indexOf(APP_HOST) + 1) % order.length]
 console.log("going...")
   this.populate(1n).then(()=>{
    this.documentIndex = this.index
    location = "https://" + HOST_PREFIX + next + location.pathname + location.hash
   })
  })
 }, 500000)
*/
`,
   "https://client.boot.core.parts/notify.js": `super.notify(from)
this.documentIndex = this.index`,

   "https://menu.core.parts/core.uri": "https://composite.core.parts",
   "https://menu.core.parts/constructor.js": `const apps = ["core.parts", "fallback.cloud", "kireji.io", "glowstick.click", "ejaugust.com", "orenjinari.com"].sort()
super(["sidebar", "app", "https://colormode.core.parts"])
this.apps = apps`,
   "https://menu.core.parts/enter.js": `this.controller.stylesheet.replaceSync(\`html, body {
 --sidebar-tween: 0;
 --sidebar-width: 256px;
 --vellum-white: #faf9f8;
...
sidebarHeading.innerHTML = \`<span id=logo>Kireji</span><span class=label>\${APP_SHORT_NAME}</span><span id=version>0.87.7</span>\`
...
for (let i = 0; i < this.apps.length; i++) {
 ...
 appNode.onclick = () => {
  ...
  if (APP_HOST !== host) location = "https://" + HOST_PREFIX + host + "/#d"
  console.warn("don't forget to make this hardcoded hash into a dynamic one!")
 }
}
...
document.body.innerHTML = ""`,
   ...
   "https://sidebar.menu.core.parts/core.uri": "https://decision.core.parts",
...
this.button.onclick = async () => {
 ...
 this.controller?.controller?.notify(this.controller.origin)
}
...
this.sidebar.removeAttribute("style")`,
   ...
   "https://introduce.sidebar.menu.core.parts/core.uri": "https://decision.core.parts",
...
this.sidebar.removeAttribute("style")`,
   ...
   "https://dismiss.sidebar.menu.core.parts/core.uri": "https://decision.core.parts",
...
await super.enter()`,
   ...
   "https://app.menu.core.parts/core.uri": "https://decision.core.parts",
   "https://app.menu.core.parts/constructor.js": `super(["https://error503.fallback.cloud", "https://orenjinari.com"])`,
   "https://app.menu.core.parts/enter.js": `this.container = this.controller.appRoot
this.stylesheet = new CSSStyleSheet()
this.container.adoptedStyleSheets.push(this.stylesheet)
// if (APP_HOST === "orenjinari.com") {
//  this.populate(this.options["https://" + APP_HOST].offset)
//  console.log("todo: better host-specific transitioning. each website's #1 should be it's home page!")
// }
await super.enter()
`,
   "https://app.menu.core.parts/leave.js": `await super.leave()
this.container.adoptedStyleSheets = []`,

   "https://colormode.core.parts/core.uri": "https://decision.core.parts",
  ...
  E = this.constructor === this.Window ? "client" : "server",
  L = false,
  𝕋 = {},
  C = "https://core.parts",
  T = ([𝑥]) =>
   (𝕋[𝑥] ??= eval(
    `(class ${𝑥.slice(8).replaceAll(".", "_")}${𝑥 === C ? "" : ` extends T\`${𝕐[`${𝑥}/core.uri`] || C}\``}{get origin(){return"https://${𝑥.slice(8)}"}${[
     ["constructor", (𝕐[`${𝑥}/inputs.txt`] ?? "").replaceAll(/\s+/g, ", "), 1],
     ["notify", "from", 1],
     ["enter"],
     ["populate", "index"],
     ["leave"],
     ...
     .map(([ƒ, x = "", s], i) =>
      `${𝑥}/${ƒ}.js` in 𝕐 || L
       ? `${s ? "" : "async "}${ƒ}(${x}){${L ? `${G}(\`\${E}::${𝑥}[0].${ƒ}(${x})\`);` : ""}${𝕐[`${𝑥}/${ƒ}.js`] ?? `${s ? "" : "await "}super${i === 0 ? "" : "." + ƒ}(${x})`}${
          L ? `;${G}End()` : ""
         }}`
       : "",
     )
 ...
 new T`https://boot.core.parts`().enter()
}
boot()
