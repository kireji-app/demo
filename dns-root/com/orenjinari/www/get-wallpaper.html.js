...
sectionNames.forEach((bunnyName, bunnyIndex) => {
 ...
 areas.push(`<div class=placeholder>${IS_PRODUCTION ? "" : `<h1>Area ${bunnyIndex + 1}</h1>`}<span class=float><img src="${src}"><span class=thin>is </span><span>coming soon.</span></span></div>`)
