...
part.popup.innerHTML = `
 <img src="https://${part.parent[LAYER].host}${Framework.version}still.png" alt="Still image captured from ${part.niceName}">
 <h3>${part.niceName}</h3>
...
//  await part.parent[LAYER].parent[LAYER].setLayer(LAYER, 0n)
// }
...
part.playButton.onclick = async () => { /*
 ...
 await part.parent[LAYER].setLayer(LAYER, 1n)
}
