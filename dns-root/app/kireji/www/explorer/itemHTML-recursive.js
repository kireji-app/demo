...
for (const subpart of SUBJECT) {
 ...
 const handle = subpart.length ? `<svg onclick="_.noop(event); _.app.kireji.www.explorer.toggle(this)" xmlns="http://www.w3.org/2000/svg" viewBox="-1 -1 2 2" class="explore-toggle"><line x1="-0.41" y1="0" x2="0.41" y2="0" stroke-width="0.2" stroke-linecap="round" />` : ""
