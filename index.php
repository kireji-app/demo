<? $Δ = [
 ...
 "https://core.parts/php/installer.html" => '
  <script>
  ...
  $ > core.parts
  $ > installing...',
 "https://core.parts/php/username.txt~" => '(""+registered === "1") ? JSON.parse(""+usernames)[user] : "guest"',
 ...
 "https://core.parts/php/everything.php~" => 'console.warn("produce everything.php right now. it will need the conversion from json to php array...", "$Δ = [ $1 ]; eval(\"?>\" . $Δ[\"https://core.parts/php/index.php\"] . \"<?php \");")',
 ...
 "https://core.parts/factory-reset-button/layout.css" => ':host { width: 16px; height: 16px; cursor: pointer } :host::before { content: \'🧼\'; font-size: 16px; line-height: 16px }',
 ...
 "https://core.parts/fullscreen-button/layout.css" => ':host { width: 16px; height: 16px; cursor: pointer } :host::before { content: \'⛶\'; font-size: 16px; line-height: 16px }',
 ...
 "https://core.parts/layout.css" => ':host { position: fixed; top: 0; left: 0; width: 100%; box-sizing: border-box; height: 100%; margin: 0; display: grid; grid-template-rows: 1fr 28px; font: 11px / 16px sans-serif }',
 ...
 "https://core.parts/os-95/desktop-/onclick.js" => '()=>{}',
 ...
 "https://core.parts/os-95/manifest.uri" => 'https://core.parts/os-95/desktop- https://core.parts/os-95/windows/file-browser-0 https://core.parts/os-95/taskbar-',
 ...
 "https://core.parts/os-95/programs/file-browser/app-label/layout.css" => ':host { margin: 0; height: 16px; vertical-align: center; text-overflow: ellipsis; overflow: hidden } :host::after { content: \'File Browser - https://\'; white-space: nowrap; }',
 ...
 "https://core.parts/os-95/programs/graph-editor/app-icon/layout.css" => ':host { --size: 16px; width: var(--size); height: var(--size) } :host::before { content: \'🧬\'; font-size: var(--size); line-height: var(--size) }',
 ...
 "https://core.parts/os-95/taskbar-/file-browser/index.txt" => '1',
 ...
 "https://core.parts/os-95/taskbar-/file-browser/layout.css" => ':host { position: relative; height: 100%; margin: 0; width: 160px; display: flex; flex-flow: row nowrap; gap: 3px; border: none ; box-sizing: border-box; padding: 3px 2px 2px; text-align: left; box-shadow: inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb }   app-icon { width: 16px; height: 16px }',
 ...
 "https://core.parts/os-95/taskbar-/file-browser/onclick.js" => '() => { Ω[\'https://core.parts/os-95/windows/file-browser-0/active.txt\'] = \'1\' }',
 ...
 "https://core.parts/os-95/taskbar-/graph-editor/index.txt" => '3',
 ...
 "https://core.parts/os-95/taskbar-/graph-editor/onclick.js" => '() => { Ω[\'https://core.parts/os-95/windows/graph-editor-0/minimized.txt\'] = \'0\'; Ω[\'https://core.parts/os-95/windows/graph-editor-0/active.txt\'] = \'1\' }',
 ...
 "https://core.parts/os-95/taskbar-/manifest.uri" => 'https://core.parts/os-95/taskbar-/start-button https://core.parts/os-95/taskbar-/file-browser https://core.parts/os-95/taskbar-/graph-editor https://core.parts/flex-spacer https://core.parts/os-95/taskbar-/tray-',
 ...
 "https://core.parts/os-95/taskbar-/start-button/icon-/layout.css" => ':host { position: relative; box-sizing: border-box; height: 100%; margin: 0; background: url(data:image/png;base64,); background-size: 16px; width: 16px; height: 16px }',
 ...
 "https://core.parts/os-95/taskbar-/start-button/layout.css" => ':host { flex: 0 0; position: relative; width: 100%; box-sizing: border-box; height: 100%; display: flex; flex-flow: row nowrap; gap: 3px; border: none; font: bold 11px / 16px sans-serif; box-sizing: border-box; padding: 3px 4px 2px; text-align: left; background: #c3c3c3; box-shadow: inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb } ',
 ...
 "https://core.parts/os-95/taskbar-/start-menu/network-folder/app-icon/layout.css" => ':host { --size: 16px } :host::before { content: \'🔭\'; font-size: var(--size); line-height: var(--size) }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/active.txt" => '0',
 ...
 "https://core.parts/os-95/windows/file-browser-0/address.uri" => 'https://',
 ...
 "https://core.parts/os-95/windows/file-browser-0/explorer-view/files-/layout.css" => ':host { display: grid; grid-template-columns: 256px 128px 1fr; grid-auto-rows: 18px; grid-template-areas: "up up up" } parent-folder { grid-area: up }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/explorer-view/files-/parent-folder/ondblclick.js" => '() => Ω[\'https://core.parts/os-95/windows/file-browser-0/address.uri\'] = \'https:/\'',
 ...
 "https://core.parts/os-95/windows/file-browser-0/explorer-view/header-/layout.css" => ':host { display: grid; width: 100%; height: 18px; grid-template-columns: 256px 128px 1fr }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/explorer-view/headers.json" => '{"name":"Name","type":"Type","size":"Size"}',
 ...
 "https://core.parts/os-95/windows/file-browser-0/layout.css" => ':host { width: 412.50390625px; height: 245.48046875px; left: 136.64453125px; top: 118.046875px; min-height: fit-content; padding: 4px; background: #c3c3c3; box-shadow: inset -1px -1px black, inset 1px 1px #c3c3c3, inset -2px -2px #7a7a7a, inset 2px 2px white; position: absolute; display: flex; flex-flow: column nowrap; gap: 2px; background: #c3c3c3; box-sizing: border-box }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/maximize-button/layout.css" => ':host { position: relative; width: 16px; height: 14px; background: #c3c3c3; box-shadow: inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb } :host::before { --color: black; display: block; position: absolute; content: ""; width: 9px; height: 9px; top: 2px; left: 3px; box-shadow: inset 0 2px var(--color), inset 0 0 0 1px var(--color) } :host(:hover)::before { --color: blue }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/minimize-button/layout.css" => ':host { position: relative; width: 16px; height: 14px; background: #c3c3c3; box-shadow: inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb } :host::before { --color: black; display: block; position: absolute; content: ""; width: 6px; height: 2px; background: var(--color); top: 9px; left: 4px } :host(:hover)::before { --color: blue }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/onpointerdown.js" => '() => { Ω[\'https://core.parts/os-95/taskbar-/selected.txt\'] = \'1\' }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/pointer-transform.js" => '
  ({ clientX: x, clientY: y }) => {
   const
 ...
 "https://core.parts/os-95/windows/file-browser-0/sort_order.json" => '{"size":false,"type":true,"name":false}',
 ...
 "https://core.parts/os-95/windows/file-browser-0/status-bar/layout.css" => ':host { padding: 0 3px; height: 17px; box-shadow: inset -1px -1px white, inset 1px 1px #7a7a7a; display: flex; flex-flow: row nowrap; align-items: center; } :host::after { content: \'0 files, 5 folders, 0 kireji\' }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/status/file_count.txt" => '0',
 ...
 "https://core.parts/os-95/windows/file-browser-0/status/folder_count.txt" => '5',
 ...
 "https://core.parts/os-95/windows/file-browser-0/status/kireji_count.txt" => '0',
 ...
 "https://core.parts/os-95/windows/file-browser-0/title-bar/layout.css" => ':host { background: #7f7f7f; color: white; display: flex; flex-flow: row nowrap; align-items: center; gap: 3px; height: 18px; padding: 0px 2px; box-sizing: border-box; } app-icon { width: 16px; height: 16px }',
 ...
 "https://core.parts/os-95/windows/file-browser-0/window-controls/manifest.uri" => 'https://core.parts/os-95/windows/file-browser-0/minimize-button https://core.parts/os-95/windows/file-browser-0/maximize-button https://core.parts/os-95/windows/file-browser-0/exit-button',
 ...
 "https://core.parts/os-95/windows/graph-editor-0/active.txt" => '0',
 ...
 "https://core.parts/os-95/windows/graph-editor-0/onpointerdown.js" => '() => { Ω[\'https://core.parts/os-95/taskbar-/selected.txt\'] = \'3\' }',
 ...
 "https://core.parts/os-95/windows/graph-editor-0/pointer-transform.js" => '
  ({ clientX: x, clientY: y }) => {
   const
 ...
 "https://core.parts/os-95/windows/graph-editor-0/title-bar/layout.css" => ':host { background: #7f7f7f; color: white; display: flex; flex-flow: row nowrap; align-items: center; gap: 3px; height: 18px; padding: 0px 2px; box-sizing: border-box; } app-icon { width: 16px; height: 16px }',
 ...
 "https://core.parts/os/icons/folder-icon/layout.css" => ':host { --size: 16px; width: var(--size); height: var(--size) } :host::before { content: \'📁\'; font-size: var(--size); line-height: var(--size) }',
 "https://core.parts/os/icons/folder-icon?layout" => 'https://core.parts/os/icons/folder-icon/layout.css',
 "https://core.parts/os/icons/image-png-icon/layout.css" => ':host { --rgba: rgba(255, 127, 0, 0.8); --character: \'📄\'; --size: 16px; color: black; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) black; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'png\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/os/icons/image-vnd-microsoft-icon-icon/layout.css" => ':host { --rgba: rgba(127, 127, 127, 0.25); --character: \'📄\'; --size: 16px; color: #373737; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) #373737; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'ico\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/os/icons/kireji-icon/layout.css" => ':host { --size: 16px; width: var(--size); height: var(--size) } :host::before { content: \'🔗\'; font-size: var(--size); line-height: var(--size) }',
 ...
 "https://core.parts/os/icons/server-icon/layout.css" => ':host { --size: 16px; width: var(--size); height: var(--size) } :host::before { content: \'🗄\'; font-size: var(--size); line-height: var(--size) }',
 "https://core.parts/os/icons/server-icon?layout" => 'https://core.parts/os/icons/server-icon/layout.css',
 "https://core.parts/os/icons/text-css-icon/layout.css" => ':host { --rgba: rgba(0, 255, 255, 0.8); --character: \'📄\'; --size: 16px; color: black; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) black; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'css\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/os/icons/text-html-icon/layout.css" => ':host { --rgba: rgba(255, 255, 255, 0.8); --character: \'📄\'; --size: 16px; color: black; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) black; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'html\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/os/icons/text-javascript-icon/layout.css" => ':host { --rgba: rgba(255, 127, 127, 0.7); --character: \'📄\'; --size: 16px; color: #5f0000; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) #5f0000; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'js\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/os/icons/text-plain-icon/layout.css" => ':host { --size: 16px; width: var(--size); height: var(--size) } :host::before { content: \'📄\'; font-size: var(--size); line-height: var(--size) }',
 "https://core.parts/os/icons/text-plain-icon?layout" => 'https://core.parts/os/icons/text-plain-icon/layout.css',
 "https://core.parts/os/icons/text-uri-list-icon/layout.uri-list" => ':host { --rgba: rgba(0, 0, 0, 0.8); --character: \'📄\'; --size: 16px; color: #ffff3f; position: relative; width: 16px; height: 16px } :host::before, :host::after { border-radius: calc(var(--size) / 6) } :host::before { content: var(--character); font-size: var(--size); line-height: var(--size) } :host::after { box-shadow: 0 0 0 calc(var(--size) / 16) #ffff3f; background: var(--rgba); position: absolute; bottom: 0; right: 0;content: \'uri\'; font: 400 calc(var(--size) / 3) / calc(var(--size) / 3) monospace; padding: calc(var(--size) / 12)}',
 ...
 "https://core.parts/templates/button.js" => '
  (url, layout = "", manifest = "", onclickjs = `()=>{ console.log("button click ${url}") }`) => {
   let parts = ("" + Ω["https://core.parts/templates/button.json"]).replace(/\$1/g, "g"+url).replace(/\$2/, layout).replace(/\$3/, manifest).replace(/"\$4"/, JSON.stringify(""+onclickjs))
   Object.entries(JSON.parse(parts)).forEach(([url, value]) => Ω[url] = value)
  }',

 "https://core.parts/templates/button.json" => '
  {
   "$1/layout.css~": "`:host { background: #c3c3c3; box-shadow: ${(\'\'+down) === \'1\' ? \'inset -1px -1px white, inset 1px 1px black, inset -2px -2px #dbdbdb, inset 2px 2px #7a7a7a\' : \'inset -1px -1px black, inset 1px 1px white, inset -2px -2px #7a7a7a, inset 2px 2px #dbdbdb\'} } $2`",
   "$1/manifest.uri": "$3",
   "$1/onclick.js": "$4",
   "$1?layout": "$1/layout.css",
   "$1?manifest": "$1/manifest.uri",
   "$1?onclick": "$1/onclick.js",
   "$1/layout.css?down": "$1/down.txt",
   "$1?onpointerdown": "$1/onpointerdown.js",
   "$1/onpointerdown.js": "e => { e.stopPropagation(); Ω[\'$1/down.txt\'] = \'1\'; Ω[\'https://core.parts/behaviors/release/src.uri\'] = \'$1/release.js\' }","$1/release.js":"e => { Ω[\'$1/down.txt\'] = \'0\' }",
   "$1/down.txt": "0",
   "$1/down.txt?fx": "$1/down-fx.uri",
   "$1/down-fx.uri": "$1/layout.css"
  }',
 ...
 "https://core.parts/templates/double_click.json" => '
  {
   "$1?ondblclick": "$1/ondblclick.js",
   "$1/ondblclick.js": "$2"
  }',
 ...
 "https://core.parts/templates/click.js" => '
  (url, js = `()=>{ console.log(\'single clicked ${url}\') }`) => {
   let parts = ("" + Ω[\'https://core.parts/templates/click.json\']).replace(/\$1/g, url).replace(/"\$2"/, JSON.stringify(""+js))
   Object.assign(Δ, JSON.parse(parts))
  }',
 "https://core.parts/templates/double_click.js" => '
  (url, js = `()=>{ console.log(\'double clicked ${url}\') }`) => {
   let parts = ("" + Ω[\'https://core.parts/templates/double_click.json\']).replace(/\$1/g, url).replace(/"\$2"/, JSON.stringify(""+js))
   Object.assign(Δ, JSON.parse(parts))
  }',
