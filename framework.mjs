...
class Framework {
 ...
 static archive = null
 static tags = null
 static get indexHTML() { return `<!DOCTYPE html><html lang=en><head><link rel=manifest /><link rel=icon href="data:image/png;base64,iVBORw0KGgo="><link rel="apple-touch-icon" href="data:image/png;base64,iVBORw0KGgo="><meta name=robots content=noindex /><meta name=viewport content="width=device-width,initial-scale=1.2,minimum-scale=1.2,maximum-scale=1.2" /> <script defer src=/${this.clientScriptURL}></script></head></html>` }
